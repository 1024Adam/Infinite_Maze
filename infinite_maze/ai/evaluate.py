"""
Utilities for evaluating and visualizing the Infinite Maze AI agent's performance.
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Evaluate trained Infinite Maze AI agent')
